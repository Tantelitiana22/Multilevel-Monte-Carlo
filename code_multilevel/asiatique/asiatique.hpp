...
struct var_mean{
	...
	double meanPl; // retourne l'esperance de p_
...
var_mean V_L_mean_asiat(int l,int n){
 ...
 * ********************************************************************/
 ...
 unsigned long long  N_l_asiat(int l,int L,double tab[] ){
...
double Y_l_asiat(int l, unsigned long long n){
